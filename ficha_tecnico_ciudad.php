...
<div class="container">
    ...
    try {
        ...
        if (isset($_GET['id']) && is_numeric($_GET['id'])) {
            ...
            // Consulta SQL para obtener los datos del producto de la tabla "articulos" con la categoría "ciudad"
                    $sql = "SELECT * FROM articulos WHERE categoria = 'ciudad' AND id = :id";
