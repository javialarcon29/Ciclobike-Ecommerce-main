...
.container {
    width: 80%;
    max-width: 1200px;
    margin: 20px auto; /* Reducir el margen vertical */
...
h2 {
    ...
    padding-bottom: 5px; /* Reducir el padding inferior */
...
.item-img {
    ...
    display: block;
    margin: 0 auto 10px auto; /* Reducir el margen inferior */
    border-radius: 8px;
...
<div class="container">
    ...
    try {
        ...
        if (isset($_GET['id']) && is_numeric($_GET['id'])) {
            ...
            $sql = "SELECT * FROM articulos WHERE categoria = 'accesorios' AND id = :id";
            ...
            if ($producto) {
                ...
                echo '<p><strong>Precio: ' . $producto['precio'] . '€</strong></p>';
                ...
                echo '<input type="hidden" name="producto_imagen" value="' . base64_encode($producto['imagen']) . '">';
                echo '<button type="submit" class="add-to-cart-btn">Añadir al Carrito</button>';
                echo '</form>';
