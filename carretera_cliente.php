...
<head>
    ...
    <style>
        ...
        .item {
            ...
            position: relative; /* Añadido para posicionar el icono de corazón */
        }
    ...
    <title>Catálogo de Carretera</title>
</head>
<body>
<?php
session_start();
        ...
        <div class="content-items" id="product-container">
            ...
            <div class="items">
                ...
                try {
                    ...
                    $query = $pdo->query("SELECT * FROM articulos WHERE categoria = 'carretera'");
                    ...
                    foreach ($productos as $producto) {
                        ...
                        echo '<a href="ficha_tecnico_carret.php?id=' . htmlspecialchars($producto['id']) . '">';
